...
<head>
    ...
    <link rel="stylesheet" href="/css/vps.css">
    <title>RonanHost | VPS</title>
...
<body>
    ...
    <section class="hero">
        <div>
            <div>
                <h1>VPS hosting </h1>
                <p>Sandbox cloud KVM VPS hosting with unlimited traffic and fast storage!</p>
                <span>
            ...
            <div>
                <table>
                    <tr>
                        <th></th>
                        <th>Sandbox</th>
                        <th class="highlight">Personal</th>
                        <th>Small Company</th>
                        <th>Company</th>
